...
export default function MyStore() {
  ...
  useEffect(() => {
    const fetchSingleProduct = async () => {
      try {
        const response = await api.get(`/template/unishop-the-complete-e-commerce-website`);
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href={singleProduct?.link+`/admin`} target='_blank' className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden mb-8">
        <div className="p-6">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="relative w-full md:w-96 h-52 rounded-lg overflow-hidden bg-gray-100">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                <Link href={`/pricing`} className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
